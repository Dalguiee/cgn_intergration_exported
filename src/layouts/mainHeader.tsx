...
//                 > */}
//                 <span className={`text-nowrap text-bold18 text-grey-900`}>
//                   {menu.text}
//                 </span>
//               </button>
//               <div
...
//   return (
//     <section
//       className={`fixed top-128 z-10 flex h-full w-full flex-col items-start justify-start gap-8 overflow-hidden bg-white-solid px-24 pt-16 md:hidden ${burger ? 'block' : 'hidden'}`}
//     >
...
//       <TopHeader />
//       <BottomHeader
//         burger={burgerVisible}
//         setBurger={setBurgerVisible}
//         centerMenu={centerMenu}
//         depthActive={depthActive}
//         setDepthActive={setDepthActive}
//       />
//       <MobileBottom burger={burgerVisible} />
