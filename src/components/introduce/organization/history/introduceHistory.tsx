...
const topHistoryData = [
  [
    // 25년
    {
      id: 0,
      time: `2`,
      text: `다큐 <바울로부터> ICVM Crown Awards 최우수해외프로덕션부문 금관상 수상<br>다큐 <바울로부터> 패키지 론칭`,
    },
    {
      id: 1,
      time: `3`,
      text: `개국 20주년 감사예배<br>CGN 홈페이지 리뉴얼<br>디지털 선교와 퐁당 세미나 개최<br>경상도 산불피해 이재민, 교회를 돕기 위한 '사랑으로 함께' 캠페인 진행<br><이스라엘로 오십쇼> CFF(Christian Film Festival) 최우수 교육 영화상 / 최고 다큐멘터리상 수상`,
    },
    {
      id: 2,
      time: `4`,
      text: `<이스라엘로 오십쇼> 휴스턴 국제영화제 Features Christian(장편 크리스천) 부문 Platinum 수상`,
    },
    {
      id: 3,
      time: `5`,
      text: `CGN 후원자 콘서트 '지금, 여기 함께!' 개최<br>행복한 가정 레이스 '달려라퐁당' 후원 챌린지 개최<br>퐁당 미디어 콘퍼런스 2025 개최`,
    },
    {
      id: 4,
      time: `6`,
      text: `개국 20주년 특집 다큐 영화 <무명> 개봉(6월 25일)`,
    },
  ],
...
const middleHistoryData = [
  [
    ...
    },
    {
      id: 3,
      time: `8`,
      text: `인도네시아 CGNTV 개국 5주년 감사예배<br />드라마 <고고송> 제15회 제천국제음악영화제 초청<br />KNOCK <미니콤 시리즈> 2019 서울 웹페스트 영화제 ‘베스트 브랜디드 시리즈’ 수상`,
    },
    {
      id: 4,
      time: `10`,
