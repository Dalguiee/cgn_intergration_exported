...
const IntroduceHistory = () => {
  ...
  return (
    ...
    >
      ...
      <section
        className={`relative flex w-full max-w-1200 flex-col items-center justify-start gap-120 pb-311 max-lg:gap-60 max-lg:pb-40 max-lg:pt-40`}
      >
        <HistoryList
