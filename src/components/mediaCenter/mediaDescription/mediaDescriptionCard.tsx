...
const mediaCardData = [
  {
    ...
    src: `/public/images/mediacenter/media_card_content_1.png`,
  },
  {
    id: 0,
    title: `CGN 라이브 채널`,
    subTitle: `CGN의 한국, 미주, 일본, 중문 채널 라이브 24시간 스트리밍`,
    src: `/public/images/mediacenter/media_card_content_2.png`,
  },
  {
    id: 0,
    title: `교회를 돕는 양육`,
    subTitle: `교회 소식부터 교회 영상과 클래스까지 교회 홈페이지처럼 맞춤으로<br />제공하는 서비스`,
    src: `/public/images/mediacenter/media_card_content_3.png`,
  },
  {
    id: 0,
    title: `이용자 참여 서비스`,
    subTitle: `댓글 서비스와 LIVE 실시간 채팅으로 나누는 복음의 은혜`,
    src: `/public/images/mediacenter/media_card_content_4.png`,
  },
  {
    id: 0,
    title: `간편 로그인과 쉬운 검색`,
    subTitle: `SNS를 통해 1초 만에 가입 및 간편 로그인, 원하는 콘텐츠를 빠르게<br />찾는 쉬운 검색`,
    src: `/public/images/mediacenter/media_card_content_5.png`,
  },
  {
    id: 0,
    title: `정주행 채널`,
    subTitle: `큐레이션 된 콘텐츠를 모두 모은 정주행 채널`,
    src: `/public/images/mediacenter/media_card_content_6.png`,
  },
];
