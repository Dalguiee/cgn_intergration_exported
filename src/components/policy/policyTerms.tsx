...
const data = [
    ...
    context: [
      ...
      },
      {
        ...
        content: [
          ...
          `3) 회사는 다음 각 호에 해당하는 사항을 인지하는 경우 이용계약 신청을 승낙하지 아니할 수 있다.`,
          {
            inner: true,
            innerContents: [
              `가. 본인의 실명을 신청하지 않은 경우`,
      ...
      {
        subTitle: `제9조 (개인정보의 보호)`,
        content: [
          `1) 회사는 이용자의 개인정보를 보호하고 존중합니다.`,
          `2) 회사는 이용자의 정보수집 시 서비스 제공에 필요한 최소한의 정보를 수집합니다. 다음 사항을 필수사항으로 하며 그 외 사항은 선택사항으로 합니다.`,
          {
            inner: true,
            innerContents: [
              `가. 성 명`,
          ...
          `5) 회사는 서비스 제공과 관련하여 다음 각 호의 경우를 제외하고는 취득한 이용자의 신상정보를 본인의 승낙 없이 제3자에게 누설 또는 배포할 수 없으며 상업적 목적으로 사용할 수 없습니다.`,
          {
            inner: true,
            innerContents: [
              `가. 관계 법령에 의하여 수사상 목적으로 정해진 절차와 방법에 따라 관계기관의 요구가 있는 경우`,
  ...
  {
    chapterTitle: `제3장 계약 당사자의 의무`,
    context: [
      {
        subTitle: `제10조 (회사의 의무)`,
        content: [
      ...
      },
      {
        subTitle: `제12조 (이용자가입)`,
        content: [
          `1) 이용자는 회사가 정한 가입 양식에 따라 이용자정보를 기입한 후 이 약관에 동의한다는 의사표시를 함으로서 이용자가입을 신청합니다. 회사는 이용자로 가입할 것을 신청한 이용자 중 다음 각 호에 해당하지 않는 한 이용자등록을 허락합니다.`,
          {
            inner: true,
            innerContents: [
              `가. 가입 신청자가 이 약관 제11조, 제13조에 의하여 이전에 이용자자격을 상실한 적이 있는 경우, 이용자자격 상실 후 3년이 경과한 자로서 회사의 이용자 재가입 승낙을 얻은 경우에는 예외로 한다.`,
              `나. 등록 내용에 허위, 기재누락, 오기가 있는 경우`,
              `다. 기타 이용자로 등록하는 것이 회사의 기술상 현저히 지장이 있다고 판단되는 경우`,
            ],
          },
      ...
      {
        subTitle: `제13조 (이용자 탈퇴 및 자격 상실 등)`,
        content: [
      ...
      {
        subTitle: `제15조 (서비스 이용신청의 유보 및 거부)`,
        content: [
          `1) 다음 각 호에 해당하는 경우 서비스 이용신청을 유보할 수 있습니다.`,
          {
            inner: true,
            innerContents: [
              `가. 기술적인 문제가 발생한 경우`,
              `나. 장비에 여유가 없는 경우`,
              `다. 회사 사정상 이용승낙이 곤란한 경우`,
            ],
          },
          `2) 다음 각 호에 해당하는 경우 서비스 이용신청을 거부할 수 있습니다.`,
          {
            inner: true,
            innerContents: [
              `가. 실명을 사용하지 않는 경우`,
              ...
              `라. 기재내용을 허위로 기재한 경우`,
              `마. 기타 회사가 정한 이용신청요건 및 사항에 미치지 못할 경우`,
            ],
          },
        ],
      },
      {
        subTitle: `제16조 (서비스 이용시간)`,
        content: [
      ...
      {
        subTitle: `제19조 (수신확인통지)`,
        content: [
          `회사는 이용자의 이용자가입 신청이 있는 경우 이용자에게 수신확인 통지를 이메일을 통해서 합니다.`,
        ],
      },
      {
        subTitle: `제20조 (연결"사이트"와 피연결"사이트" 간의 관계)`,
        content: [
...
const PolicyTerms = () => {
  return (
    ...
    >
      <div className={`flex w-full flex-col items-start justify-start gap-40`}>
        {data.map((item, idx) => (
          <div
          ...
          >
            <p
              className={`text-bold24 max-lg:text-bold18 w-full text-center text-primary-500`}
            >
              {item?.chapterTitle}
            </p>
            ...
            {item?.context?.map((contextItem, contextIdx) => (
              <div key={contextIdx}>
                <p
                  className={`text-bold18 max-lg:text-bold16 mb-12 text-grey-500`}
                >
                ...
                >
                  {contextItem?.content?.map((content, contentIdx) =>
                    content?.inner ? (
                      <div className={`w-full pl-24`}>
                        {content?.innerContents?.map(
                          (innerContentsItem, innerContentsIdx) => (
                            <li>{innerContentsItem}</li>
                          )
                        )}
                      </div>
                    ) : (
        ...
        <div className={`text-regular18 max-lg:text-regular16 text-grey-500`}>
          <p className={`mb-12`}>[ 부 칙 ]</p>
          <p>1. 본 약관은 2018년 12월 12일부터 적용됩니다.</p>
          <p>
            2. 2003년 3월 31일부터 시행되던 종전의 약관은 본 약관으로
            대체합니다.
          </p>
        </div>
      </div>
