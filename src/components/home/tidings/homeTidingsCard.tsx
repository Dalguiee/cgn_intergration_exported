...
const HomeTidingsCard = ({ item, pageMode }) => {
  ...
  return (
    ...
    >
      <img
        className='min-h-382 w-full rounded-tl-16 rounded-tr-16 object-cover object-top max-lg:aspect-[361/24] max-lg:min-h-189 max-lg:rounded-tl-8 max-lg:rounded-tr-8'
      ...
      >
        ...
        <div
          className={`mt-12 flex w-full flex-shrink-0 items-center justify-start`}
        >
          <p
